        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Elektronik Kuitansi</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Digitalisasi Pembuatan Kuitansi Pengadaan Barang/Jasa
                    </h2>
                ...
                <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="{{ asset('img/e-kuin-logo.png') }}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
